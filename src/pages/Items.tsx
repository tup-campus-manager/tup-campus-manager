...
import { getStudents } from '../services/state.service';
import type { Student } from '../services/state.service';
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        console.error(err);
        setError(
          'No se pudieron obtener los estudiantes. Intentá de nuevo más tarde.'
        );
      } finally {
        setLoading(false);
      }
